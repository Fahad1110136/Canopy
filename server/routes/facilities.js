...
router.get('/', requireAuth, async (req, res) => {
  res.json(await getFacilitiesByCompany(req.user.companyId))
})

router.get('/:id', requireAuth, async (req, res) => {
  const f = await getFacilityById(req.params.id)
...
router.put('/:id', requireAuth, async (req, res) => {
  ...
  res.json(await updateFacility(req.params.id, updates))
})
